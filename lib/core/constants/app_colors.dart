...
class AppColors {
  ...
  static const Color navigationSelected = Color(0xFF6200EE);
  static const Color navigationUnselected = Color(0xFF757575);

  // TabBar colors
  static const Color tabSelected = Color(0xFF6200EE);
  static const Color tabUnselected = Color(0xFFFFFFFF);
}
